...
test.describe('Get Project Template', () => {
  ...
  test('Get Project Templates', async () => {
    ...
    expect(output[0].pages[0].reportWidgets[0].layoutItemProperties.alignItems).toBe(projectTemplateInfoObj.pages[0].reportWidgets[0].layoutItemProperties.alignItems)
    expect(output[0].pages[0].reportWidgets[0].layoutItemProperties.bgcolor).toBe(projectTemplateInfoObj.pages[0].reportWidgets[0].layoutItemProperties.bgcolor)
    expect(output[0].pages[0].reportWidgets[0].layoutItemProperties.color).toBe(projectTemplateInfoObj.pages[0].reportWidgets[0].layoutItemProperties.color)
    expect(output[0].pages[0].reportWidgets[0].layoutItemProperties.justifyContent).toBe(projectTemplateInfoObj.pages[0].reportWidgets[0].layoutItemProperties.justifyContent)
