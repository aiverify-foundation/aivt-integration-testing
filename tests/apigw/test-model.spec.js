...
test.describe('Test Models', () => {
    ...
    const POST_TEST_MODELS_FOLDER = [
        { TEST_NAME: "With Valid File Arrays With Classification Model Type Arrays With File Type Folder With Folder Name Between 1 to 128 Characters With No Sub Folder Array", ALGORITHM_ROOT_FOLDER: "veritas_data", FOLDER_PARAMETERS: FOLDER_PARAMETERS[0], FILES: ARRAY_OF_FOLDER_FILES[0], STATUS: 200 },
        ...
        { TEST_NAME: "With Valid File Arrays With Regression Model Type Arrays With File Type Folder With Folder Name Between 1 to 128 Characters With Valid No Sub Folder Array", ALGORITHM_ROOT_FOLDER: "veritas_data", FOLDER_PARAMETERS: FOLDER_PARAMETERS[2], FILES: ARRAY_OF_FOLDER_FILES[2], STATUS: 200 },
