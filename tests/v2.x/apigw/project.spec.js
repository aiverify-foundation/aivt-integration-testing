...
const UPDATE_PROJECT_BY_PROJECT_ID = [
    ...
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Project Info Description Empty With Valid Test Model Id With Valid Input Blocks With With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 17, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { globalVars: [ { key: 'Company Name', value: 'ABC Company' } ], pages: [], templateId: null, projectInfo: { name: 'My Test Project', description: '', reportTitle: 'My Report Title', company: 'Company ABC' }, testModelId: 17, inputBlocks: [ { gid: 'aiverify.stock.fairness_metrics_toolbox_for_classification', cid: 'fairness_tree', id: 1 } ], testResults: [ { gid: 'aiverify.stock.accumulated_local_effect', cid: 'aiverfy_accumulated_local_effect', id: 1 }] }, STATUS: 200 },
    ...
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Project Info Report Title Empty With Valid Test Model Id With Valid Input Blocks With With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": ""}, TEST_MODEL_ID: 17, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { globalVars: [ { key: 'Company Name', value: 'ABC Company' } ], pages: [], templateId: null, projectInfo: { name: 'My Test Project', description: 'My Test Project Description', reportTitle: '', company: 'Company ABC' }, testModelId: 17, inputBlocks: [ { gid: 'aiverify.stock.fairness_metrics_toolbox_for_classification', cid: 'fairness_tree', id: 1 } ], testResults: [ { gid: 'aiverify.stock.accumulated_local_effect', cid: 'aiverfy_accumulated_local_effect', id: 1 }] }, STATUS: 200 },
