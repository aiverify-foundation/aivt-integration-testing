...
const CREATE_PROJECT = [
    ...
    { TEST_NAME: "With Name Character Length <= 128 Characters With Description With Report Title With Company Name Empty", CASE_TYPE: "POSITIVE", COMPANY: "", DESCRIPTION: "My Test Project Description", NAME: "My Test Project", REPORT_TITLE: "My Report Title", STATUS: 200 }, // Can be Empty?
    { TEST_NAME: "With Name Character Length <= 128 Characters With Description With Report Title With Company Name Null", CASE_TYPE: "POSITIVE", COMPANY: null, DESCRIPTION: "My Test Project Description", NAME: "My Test Project", REPORT_TITLE: "My Report Title", STATUS: 200 }, // Can be Null?
    ...
    { TEST_NAME: "With Name Character Length <= 128 Characters With Description With Report Title Empty With Company Name", CASE_TYPE: "POSITIVE", COMPANY: "Company ABC", DESCRIPTION: "My Test Project Description", NAME: "My Test Project", REPORT_TITLE: "", STATUS: 200 },
    ...
    { TEST_NAME: "With Name Character Length <= 128 Characters With Description Empty With Report Title With Company Name", CASE_TYPE: "POSITIVE", COMPANY: "Company ABC", DESCRIPTION: "", NAME: "My Test Project", REPORT_TITLE: "My Report Title", STATUS: 200 },
...
const GET_PROJECT_BY_PROJECT_ID = [
    ...
    { TEST_NAME: "With Non-Existing Project Id", CASE_TYPE: "NEGATIVE", PROJECT_ID: 100000000000000, EXPECTED: { detail: 'Internal error 404: Project not found' }, STATUS: 500 }, // Should status be 404?
...
const UPDATE_PROJECT_BY_PROJECT_ID = [
    ...
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Valid Test Model Id With Valid Input Blocks With Test Results No Values", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 17, INPUT_BLOCK: [1], EXPECTED: { globalVars: [ { key: 'Company Name', value: 'ABC Company' } ], pages: [], id: 1, templateId: null, projectInfo: { name: 'My Test Project', description: 'My Test Project Description', reportTitle: 'My Report Title', company: 'Company ABC' }, testModelId: 17, inputBlocks: [{ gid: 'aiverify.stock.fairness_metrics_toolbox_for_classification', cid: 'fairness_tree', id: 1 }], testResults: [], }, STATUS: 200 },
    ...
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Valid Test Model Id With Input Blocks No Values With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 17, TEST_RESULT: [1], EXPECTED: { globalVars: [ { key: 'Company Name', value: 'ABC Company' } ], pages: [], id: 1, templateId: null, projectInfo: { name: 'My Test Project', description: 'My Test Project Description', reportTitle: 'My Report Title', company: 'Company ABC' }, testModelId: 17, inputBlocks: [], testResults: [ { gid: 'aiverify.stock.accumulated_local_effect', cid: 'aiverfy_accumulated_local_effect', id: 1 }], }, STATUS: 200 },
    ...
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id String With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 'abc', INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'int_parsing', loc: [ 'body', 'testModelId' ], msg: 'Input should be a valid integer, unable to parse string as an integer', input: "abc" }]}, STATUS: 422 },
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id Float With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 12.3, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'int_from_float', loc: [ 'body', 'testModelId' ], msg: 'Input should be a valid integer, got a number with a fractional part', input: 12.3 }]}, STATUS: 422 },
    // { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id Boolean With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: true, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'list_type', loc: [ 'body', 'testModelId' ], msg: 'Input should be a valid list', input: true }]}, STATUS: 422 }, // Because true == 1, Test Result Array becomes [1]
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id Empty With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: "", INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'int_parsing', loc: [ 'body', 'testModelId' ], msg: 'Input should be a valid integer, unable to parse string as an integer', input: "" }]}, STATUS: 422 },
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id Null With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: null, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { globalVars: [ { key: 'Company Name', value: 'ABC Company'}], pages: [], id: 1, templateId: null, projectInfo: { name: 'My Test Project', description: 'My Test Project Description', reportTitle: 'My Report Title', company: 'Company ABC' }, testModelId: null, inputBlocks: [{ gid: 'aiverify.stock.fairness_metrics_toolbox_for_classification', cid: 'fairness_tree', id: 1 }], testResults: [ { gid: 'aiverify.stock.accumulated_local_effect', cid: 'aiverfy_accumulated_local_effect', id: 1 }] }, STATUS: 200 },
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id No Values With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { globalVars: [ { key: 'Company Name', value: 'ABC Company'}], pages: [], id: 1, templateId: null, projectInfo: { name: 'My Test Project', description: 'My Test Project Description', reportTitle: 'My Report Title', company: 'Company ABC' }, testModelId: null, inputBlocks: [{ gid: 'aiverify.stock.fairness_metrics_toolbox_for_classification', cid: 'fairness_tree', id: 1 }], testResults: [ { gid: 'aiverify.stock.accumulated_local_effect', cid: 'aiverfy_accumulated_local_effect', id: 1 }] }, STATUS: 200 },
    ...
    // { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Project Info Name Empty With Valid Test Model Id With Valid Input Blocks With With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 17, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'string_type', loc: [ 'body', 'projectInfo', 'name'], msg: 'Input should be a valid string', input: "" }]}, STATUS: 422 }, // Can Name be empty?
    ...
    // { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Project Info Description Empty With Valid Test Model Id With Valid Input Blocks With With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 17, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'string_type', loc: [ 'body', 'projectInfo', 'description'], msg: 'Input should be a valid string', input: "" }]}, STATUS: 422 }, // Can Description be empty?
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Project Info Description Null With Valid Test Model Id With Valid Input Blocks With With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": null, "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 17, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { pages: [], id: 1, templateId: null, projectInfo: { name: 'My Test Project', description: null, reportTitle: 'My Report Title', company: 'Company ABC' }, testModelId: 17, inputBlocks: [{ gid: 'aiverify.stock.fairness_metrics_toolbox_for_classification', cid: 'fairness_tree', id: 1 }], testResults: [{ gid: 'aiverify.stock.accumulated_local_effect', cid: 'aiverfy_accumulated_local_effect', id: 1 }] }, STATUS: 200 }, // To check if global vars should be included in response
    ...
    // { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Project Info Report Title Empty With Valid Test Model Id With Valid Input Blocks With With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": ""}, TEST_MODEL_ID: 17, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'string_type', loc: [ 'body', 'projectInfo', 'reportTitle'], msg: 'Input should be a valid string', input: "" }]}, STATUS: 422 }, // Can Report Title be empty?
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Project Info Report Title Null With Valid Test Model Id With Valid Input Blocks With With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": null }, TEST_MODEL_ID: 17, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { pages: [], id: 1, templateId: null, projectInfo: { name: 'My Test Project', description: 'My Test Project Description', reportTitle: null, company: 'Company ABC' }, testModelId: 17, inputBlocks: [{ gid: 'aiverify.stock.fairness_metrics_toolbox_for_classification', cid: 'fairness_tree', id: 1 }], testResults: [{ gid: 'aiverify.stock.accumulated_local_effect', cid: 'aiverfy_accumulated_local_effect', id: 1 }] }, STATUS: 200 }, // To check if global vars should be included in response
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Project Info Report Title No Value With Valid Test Model Id With Valid Input Blocks With With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project" }, TEST_MODEL_ID: 17, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { pages: [], id: 1, templateId: null, projectInfo: { name: 'My Test Project', description: "My Test Project Description", reportTitle: null, company: 'Company ABC' }, testModelId: 17, inputBlocks: [{ gid: 'aiverify.stock.fairness_metrics_toolbox_for_classification', cid: 'fairness_tree', id: 1 }], testResults: [{ gid: 'aiverify.stock.accumulated_local_effect', cid: 'aiverfy_accumulated_local_effect', id: 1 }] }, STATUS: 200 }, // To check if global vars should be included in response
...
const PATCH_PROJECT_BY_PROJECT_ID = [
    ...
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Valid Test Model Id With Input Blocks Null With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 17, INPUT_BLOCK: [null], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'int_type', loc: [ 'body', 'inputBlocks', 0 ], msg: 'Input should be a valid integer', input: null }]}, STATUS: 422 },
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Valid Test Model Id With Input Blocks No Values With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 17, TEST_RESULT: [1], EXPECTED: { globalVars: [ { key: 'Company Name', value: 'ABC Company' } ], pages: [], id: 1, templateId: null, projectInfo: { name: 'My Test Project', description: 'My Test Project Description', reportTitle: 'My Report Title', company: 'Company ABC' }, testModelId: 17, inputBlocks: [], testResults: [ { gid: 'aiverify.stock.accumulated_local_effect', cid: 'aiverfy_accumulated_local_effect', id: 1 }], }, STATUS: 200 },
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Non-Existing Test Model Id With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 100000000000000, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: "Test Model 100000000000000 not found" }, STATUS: 404 }, // Not 404?
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id String With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 'abc', INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'int_parsing', loc: [ 'body', 'testModelId' ], msg: 'Input should be a valid integer, unable to parse string as an integer', input: "abc" }]}, STATUS: 422 },
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id Float With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: 12.3, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'int_from_float', loc: [ 'body', 'testModelId' ], msg: 'Input should be a valid integer, got a number with a fractional part', input: 12.3 }]}, STATUS: 422 },
    // { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id Boolean With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: true, INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'list_type', loc: [ 'body', 'testModelId' ], msg: 'Input should be a valid list', input: true }]}, STATUS: 422 }, // Because true == 1, Test Result Array becomes [1]
    { TEST_NAME: "With Existing Project Id With Valid Global Vars With Valid Pages With Valid Project Info With Test Model Id Empty With Valid Input Blocks With Valid Test Results", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, GLOBAL_VARS: [ { key: "Company Name", value: "ABC Company" } ], PAGES: [], PROJECT_INFO_DATA: { "company": "Company ABC", "description": "My Test Project Description", "name": "My Test Project", "reportTitle": "My Report Title" }, TEST_MODEL_ID: "", INPUT_BLOCK: [1], TEST_RESULT: [1], EXPECTED: { detail: [ { type: 'int_parsing', loc: [ 'body', 'testModelId' ], msg: 'Input should be a valid integer, unable to parse string as an integer', input: "" }]}, STATUS: 422 },
...
const SAVE_PROJECT_AS_TEMPLATE = [
    ...
    // { TEST_NAME: "With Existing Project Id With Project Info Name String With Project Info Description Empty", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, PROJECT_TEMPLATE_NAME: "My Test Project Template", PROJECT_TEMPLATE_DESCRIPTION: "", STATUS: 200 }, // Can Description Be Empty? And what value should it be since it has a 200? Yet Value for description is not empty.
    // { TEST_NAME: "With Existing Project Id With Project Info Name String With Project Info Description Null", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, PROJECT_TEMPLATE_NAME: "My Test Project Template", PROJECT_TEMPLATE_DESCRIPTION: "", EXPECTED: { detail: [ { type: 'string_type', loc: [ 'body', 'description' ], msg: 'Input should be a valid string', input: null } ] }, STATUS: 422 }, // Can Description Be Null? And what value should it be since it has a 200? Yet Value for description is not empty.
    // { TEST_NAME: "With Existing Project Id With Project Info Name String With Project Info Description No Value", CASE_TYPE: "NEGATIVE", PROJECT_ID: 1, PROJECT_TEMPLATE_NAME: "My Test Project Template", EXPECTED: { detail: [ { type: 'string_type', loc: [ 'body', 'description' ], msg: 'Input should be a valid string', input: 123 } ] }, STATUS: 422 }, // Can Description Be No Value? And what value should it be since it has a 200? Yet Value for description is not empty.
...
test.describe('Project', () => {
    ...
    for (const data of GET_PROJECT) {
        test.skip(`Get All Project ${data.TEST_NAME}`, async () => {
            ...
            expect.soft(response.data[0].testModelId).toBeNull()
    ...
    for (const data of UPDATE_PROJECT_BY_PROJECT_ID) {
        ...
        test.skip(`Update Project By ID ${data.TEST_NAME}`, async () => {
            ...
            if (data.CASE_TYPE == "POSITIVE") {
                ...
                expect.soft(response.data.testResults).toMatchObject([{"cid": "fairness_metrics_toolbox_for_classification", "gid": "aiverify.stock.fairness_metrics_toolbox_for_classification", "id": parseInt(test_results_id[2])}])
                expect.soft(response.data.created_at).toBeTruthy()
                expect.soft(response.data.updated_at).toBeTruthy()
    ...
    for (const data of DELETE_PROJECT_BY_ID) {
        ...
        test.skip(`Delete Project By ID ${data.TEST_NAME}`, async () => {
    ...
    for (const data of SAVE_PROJECT_AS_TEMPLATE) {
        ...
        test.skip(`Save Project As Template ${data.TEST_NAME}`, async () => {
            ...
            if (data.CASE_TYPE == "POSITIVE") {
                ...
                // expect.soft(response.data.inputBlocks).toBeTruthy()
                // expect.soft(response.data.testResults).toBeTruthy()
                // expect.soft(response.data.fromPlugin).toBeTruthy()
                expect.soft(response.data.created_at).toBeTruthy()
                expect.soft(response.data.updated_at).toBeTruthy()
