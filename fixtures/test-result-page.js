...
export class TestResultPage {
  ...
  async imageCorruption(parameters) {
    ...
    await expect.soft(this.page.getByText('image corruption toolboxSUCCESS').nth(0)).toBeVisible({ timeout: 12000 })
  ...
  async runAlgorithms(parameters) {
    ...
    await expect.soft(this.page.getByText(parameters.testrunValidationSuccessText).nth(0)).toBeVisible({ timeout: 15000 })
