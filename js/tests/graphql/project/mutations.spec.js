    ...
    test('Create Project with Invalid Project Information', async () => {
        ...
        response = await axios.post(ENDPOINT, {
            ...
            variables: {
                "project": {
                    "projectInfo": {
                        //FIXME Implicitly converts to string
                        "name": true,
                        "company": true
                    }
                }
...
test.skip('Generate Report', () => {
    ...
    test('Generate Report with Invalid Model and Datasets', async () => {
        ...
        errorMessage = generateReport.data.errors
        // console.log(errorMessage) //FIXME Can generate with null data?
        ...
        // console.log(errorMessage) //FIXME Can generate with Non-existing Dataset and Model
