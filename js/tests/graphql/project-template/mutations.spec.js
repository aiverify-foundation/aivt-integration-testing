...
test.describe('Create Project Template', () => {
    ...
    test.skip('Create Project Template with Invalid Project Information', async () => {
        ...
        // FIXME Does Integer and any other non-string data type will change implicit to string?
    ...
    test.skip('Create Project Template with Empty Global Variable', async () => {
